...
.controller('SessionsCtrl', [
    ...
    function($scope){
    $scope.maxDevices = 10;
    $scope.maxDeviceTabs = 10;
    $scope.maxRecentlyClosed = 10;
...
.controller('DownloadCtrl', [
    ...
    chrome.downloads.searchAsync({limit: 40, orderBy: ['-startTime']})
...
.controller('BookmarkCtrl', [
    ...
    chrome.bookmarks.getRecentAsync(20).then(function(recents){
        $scope.$apply(function(){
	...
	backgrounds: [
		{
			...
			type: "Google Now",
			url: {
				dawn: "http://c.hiphotos.baidu.com/zhidao/pic/item/b219ebc4b74543a930b783631e178a82b80114f4.jpg",
				day: "http://c.hiphotos.baidu.com/zhidao/pic/item/b219ebc4b74543a930b783631e178a82b80114f4.jpg",
				dusk: "http://c.hiphotos.baidu.com/zhidao/pic/item/b219ebc4b74543a930b783631e178a82b80114f4.jpg",
				night: "http://c.hiphotos.baidu.com/zhidao/pic/item/b219ebc4b74543a930b783631e178a82b80114f4.jpg"
				}
		},
		{
			id: 1,
